...
BEGIN
    ...
    USING (SELECT 
           ...
           LEFT JOIN 
              Salaries sal ON TRUNC(sal.payment_date) = TRUNC(s.sale_date)
           GROUP BY 
              TRUNC(s.sale_date, 'MONTH')) new_pl
    ...
    WHEN MATCHED THEN
        UPDATE SET 
            ...
            pl.total_profit = new_pl.net_profit
    WHEN NOT MATCHED THEN
        INSERT (pl.report_date, pl.total_sales_revenue, pl.total_product_cost, pl.total_ingredient_cost, pl.total_salary_expenses, pl.total_profit)
        VALUES (new_pl.report_month, new_pl.total_sales_revenue, new_pl.total_product_cost, new_pl.total_ingredient_cost, new_pl.total_salary_expenses, new_pl.net_profit);
END;
/
