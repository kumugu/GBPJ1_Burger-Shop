...
CREATE TABLE Ingredients (
    ...
    CONSTRAINT fk_ingredient_category FOREIGN KEY (category_id) REFERENCES Ingredient_Categories(category_id)
);
...
CREATE TABLE Orders (
    ...
    CONSTRAINT fk_order_ingredient FOREIGN KEY (ingredient_id) REFERENCES Ingredients(ingredient_id)
);
...
CREATE TABLE Stock (
    ...
    CONSTRAINT fk_stock_ingredient FOREIGN KEY (ingredient_id) REFERENCES Ingredients(ingredient_id)
);
...
CREATE TABLE Stock_Logs (
    ...
    reason VARCHAR2(255),
    CONSTRAINT fk_stock_log_ingredient FOREIGN KEY (ingredient_id) REFERENCES Ingredients(ingredient_id)
);
...
CREATE TABLE Product_Ingredients (
    ...
    CONSTRAINT fk_product_ingredients_product FOREIGN KEY (product_id) REFERENCES Products(product_id),
    CONSTRAINT fk_product_ingredients_ingredient FOREIGN KEY (ingredient_id) REFERENCES Ingredients(ingredient_id)
);
