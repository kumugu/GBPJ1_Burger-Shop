...
--7. hide_menu_on_product_delete 트리거
...
--8. trigger_profit_loss_report 트리거
...
--9. update_profit_loss_sales 트리거
...
BEGIN
    ...
    WHEN NOT MATCHED THEN
        INSERT (report_date, total_sales_revenue, total_product_cost, total_ingredient_cost, total_salary_expenses, total_profit)
...
--10. update_profit_loss_orders 트리거
...
-- 11. update_profit_loss_salaries 트리거
